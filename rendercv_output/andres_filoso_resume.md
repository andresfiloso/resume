...
## **Telecom Argentina**, Sr NOC Analyst
...
# Skills
**Backend & APIs:** TypeScript, JavaScript, Node.js, NestJS, Fastify, REST API Design, Strapi CMS

**Databases & Caching:** PostgreSQL, MongoDB, Redis

**Frontend:** React, Next.js, Tailwind CSS, shadcn/ui, design systems

**Cloud & DevOps:** AWS (ECS, ECR, S3), Docker, Terraform, GitHub Actions, CI/CD
